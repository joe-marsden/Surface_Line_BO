...
if nargin == 6 
    ...
    %     n_levels(i) = length(unique(X(:,dim_qual(i)))); % requires dataset to contain data for every level of the categorical variables
    % end
    n_levels = levels; % enables levels of categorical variables to be included that currently don't have any data
